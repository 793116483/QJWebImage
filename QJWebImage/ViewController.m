...
- (void)viewDidLoad {
    ...
    imageView2.frame = CGRectMake(10, 210, self.view.frame.size.width - 20, 100);
    [self.view addSubview:imageView2];
    
    UIImageView * imageView3 = [[UIImageView alloc] init];
    imageView3.backgroundColor = [UIColor whiteColor];
    imageView3.frame = CGRectMake(10, 320, self.view.frame.size.width - 20, 100);
...
//    [imageView qj_setImageWithUrlStr:testImageURL1];
    ...
    [imageView qj_setImageWithURL:[NSURL URLWithString:testImageURL1] placeholderImage:[UIImage imageNamed:@"pic_loadsuc"] downloadProgressing:^(CGFloat curDownloadSize, CGFloat didDownloadSize, CGFloat fileSize) {
